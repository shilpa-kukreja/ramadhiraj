    ...
    <>
      ...
      <main className=" mt-25">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
              {/* Heading */}
              <div className="mb-8">
                {/* <span className="inline-block bg-red-50 text-red-700 px-4 py-2 rounded-full text-sm font-semibold tracking-wide uppercase mb-4">
          About Our Company
        </span> */}
              ...
              <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300">
                ...
                {/* Quick Stats */}
                {/* <div className="grid grid-cols-3 gap-4 mt-8">
          <div className="text-center  p-5 rounded-2xl shadow-sm hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="text-center p-5 rounded-2xl shadow-sm hover:-translate-y-1 transition-all duration-300">
            ...
            {/* Right Column */}
            <div className="relative mt-2 sm:mt-28">
              <div className="absolute top-10 -left-5 w-28 h-28 bg-red-100 rounded-full blur-3xl opacity-70"></div>

              <div className="relative h-[580px] w-full overflow-hidden rounded-[24px]">
                <img
                  src="/about/about.png"
                  alt="CEO Sanjeev Arora"
              ...
              {/* Floating Badge */}
              {/* <div className="absolute bottom-8 left-8 bg-white/95 backdrop-blur-md px-6 py-4 rounded-2xl shadow-xl border border-gray-100">
        ...
        <section className="relative overflow-hidden bg-gray-100 py-12 lg:py-12">
          {/* Background Effects */}
          <div className="absolute left-0 top-0 h-72 w-72 rounded-full blur-3xl opacity-40"></div>

          <div className="absolute bottom-0 right-0 h-72 w-72 rounded-full bg-gray-100 blur-3xl opacity-40"></div>
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-sm font-medium leading-7 text-gray-600 md:text-base">
                Built on innovation, integrity, and commitment towards
                industrial safety excellence.
              </p>

              <div className="mt-5 flex items-center justify-center">
                <div className="h-[3px] w-16 rounded-full bg-red-600"></div>
              </div>
            </div>
                  ...
                  <div>
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                      {companyValues.map((value, index) => (
                        <div
                          key={index}
                          className="group relative overflow-hidden rounded-[24px] border border-gray-100 bg-white p-6 text-center shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-xl"
                          onMouseEnter={() => setHoveredValue(index)}
                          onMouseLeave={() => setHoveredValue(null)}
                        >
                          {/* Hover BG */}
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-center mb-12  border-gray-200 pb-6">
              <div>
                <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-2">
                  Company <span className="text-[#e21d23]">Milestones</span>
                </h2>
              </div>
            </div>
        ...
        <section className="relative overflow-hidden py-12 bg-white">
          ...
          <div className="relative max-w-9xl mx-auto">
            ...
            <div className="text-center mb-14 px-4">
              {/* <span className="inline-flex items-center rounded-full bg-red-50 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.25em] text-red-600">
                Our Credentials
              </span> */}
              ...
              <p className="mx-auto mt-4 max-w-2xl text-sm md:text-base font-medium leading-relaxed text-gray-600">
              ...
              <div className="marquee-wrapper">
                <div className="marquee-track">
                  {[...certifications, ...certifications].map((cert, index) => (
                    <div
                      key={index}
                      className="group mx-4 flex w-[280px] flex-shrink-0 cursor-pointer flex-col overflow-hidden rounded-[28px] border border-gray-100 bg-white shadow-md transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl"
        ...
        <section className="py-12 bg-gradient-to-r from-gray-900 to-gray-800">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="px-8 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-all duration-300 transform hover:scale-105"
                style={{ backgroundColor: "#e21d23" }}
              >
                Contact Our Experts
              </Link>
              <Link
                href="/products"
                className="px-8 py-3 bg-transparent border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-gray-900 transition-all duration-300"
              >
                Explore Products
              </Link>
            </div>
